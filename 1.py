...
if lengua_origen == "Español":
    if palabra_usuario in D_ingles:
        st.write("Esta palabra pertenece al inglés.")
    elif palabra_usuario in D_aleman:
        st.write("Esta palabra pertenece al alemán.")
if lengua_origen == "Inglés":
    if palabra_usuario in D_espanol:
        st.write("Esta palabra pertenece al español.")
    elif palabra_usuario in D_aleman:
        st.write("Esta palabra pertenece al alemán.")
if lengua_origen == "Alemán":
    if palabra_usuario in D_ingles:
        st.write("Esta palabra pertenece al inglés.")
    elif palabra_usuario in D_espanol:
        st.write("Esta palabra pertenece al español.")
...
if lengua_origen == "Español":
    ...
    if palabra_usuario in D_espanol:
        ...
        if distancia <= 3:  
            st.write(f"- Español: Esta palabra no se encuentra en el diccionario. ¿Quisiste decir '{palabra_cercana}'?")
...
import streamlit as st
i = Image.open("perro.jpeg")
i = i.resize((300, 200))
st.image('perro.jpg', caption='perro bonito')